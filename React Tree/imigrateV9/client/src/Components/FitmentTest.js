    ...
    return (
        <React.Fragment>
            ...
            <div className='container'>
                <div className='bg-success text-light p-1 mt-1 rounded'>
                    <h3 className=' mt-1'> <img src={fitment_icon} alt="fitment" className='xsa-icon mt-mins-5' /> <span className='mt-1'>Fitment Test</span> </h3>
                </div>
