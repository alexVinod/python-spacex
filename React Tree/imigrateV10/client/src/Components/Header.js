...
const Header = ({ settingsCog }) => {
    const hostpath = cnxnParams.JENKINSCONNECTION.HOSTPATH;
    return (
        <React.Fragment>
                ...
                <div className="modal-dialog modal-sm">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <span className="text-danger fw-bold float-end" style={{ "marginRight": "-10px", "zIndex": "2", "marginTop": "-45px" }}>*</span>
                            {/* http://34.148.75.207:32000/job/prerequisite-generator-java-gradle/buildWithParameters?token=token&TEST=fromgit&EMAIL=rama.v@tcs.com&Repository_URL=https://github.com/gaurav-dubey-gitspace/spring-music */}
                            {/* http://34.138.107.184:32000/job/Gradle-builder/buildWithParameters?token=token&TEST=fromgit&EMAIL=rama.v@tcs.com&Repository_URL=https://github.com/gaurav-dubey-gitspace/spring-music */}
