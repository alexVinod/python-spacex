...
export default function Center() {
    ...
    const clurHandler = async (e) => {
        ...
        let nameSpaceValue = document.querySelector("#namespace").value;
        let targetLocationValue = "us-central1-c";
        ...
        if (gitValue.trim() !== "" && emailValue.trim() !== "" && getUrl.trim() !== "") {
            ...
            let nameSpaceParams = "&GKE_NAMESPACE=" + nameSpaceValue;
            ...
            let urlConcatParams = `${techStackPathParams}${buildParams}${emailParams}${gitParams}${projectParams}${clusterParams}${locationParams}${nameSpaceParams}`;

            console.log("**********", alterLink + urlConcatParams);

            // "https://cors-anywhere.herokuapp.com/"
            let url = alterLink + urlConcatParams; // "http://34.148.75.207:32000/job/Gradle-builder/"; // "alterLink + "urlConcatParams";
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState === 4) {
                        ...
                        if (xhttp.status === 201 || xhttp.status === 200) {
                            ...
                            axios.post(`${hostname}/createMigrates`, data).then((_response) => {
